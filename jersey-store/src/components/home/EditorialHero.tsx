...
export const EditorialHero: React.FC = () => {
  ...
  const jerseyRotateX = useSpring(useTransform(mouseY, [-0.5, 0.5], [5, -5]), springConfig);
  const jerseyRotateY = useSpring(useTransform(mouseX, [-0.5, 0.5], [-7, 7]), springConfig);
  const jerseyTranslateX = useSpring(useTransform(mouseX, [-0.5, 0.5], [-10, 10]), springConfig);
  const jerseyTranslateY = useSpring(useTransform(mouseY, [-0.5, 0.5], [-8, 8]), springConfig);
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 w-full my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-center">
          ...
          <motion.div
            ...
            className="lg:col-span-5 flex flex-col justify-center space-y-5 text-left z-20"
          >
            ...
            <div className="space-y-1">
              <h1 className="text-5xl sm:text-6xl lg:text-[4.6rem] xl:text-[5.2rem] font-display font-black uppercase tracking-tight leading-[0.88] text-[#F3F0E8]">
                THE GAME <br />
            ...
            <div className="pt-1 flex flex-wrap items-center gap-4 sm:gap-5">
              ...
              <Link
                to="/collection"
                className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[#E3261E] hover:bg-[#c81e17] text-white font-mono font-bold text-xs sm:text-sm uppercase tracking-wider transition-all duration-300 shadow-[0_0_25px_rgba(227,38,30,0.5)] hover:shadow-[0_0_35px_rgba(227,38,30,0.75)] hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-4 relative flex items-center justify-center min-h-[420px] sm:min-h-[480px]">
            ...
            <motion.div
              ...
              className="relative w-full max-w-[380px] sm:max-w-[440px] flex items-center justify-center z-10"
            >
              ...
              <div className="relative w-full aspect-[4/4.3] flex items-center justify-center">
                  ...
                  >
                    {currentView.isCutout ? (
                      <img
                        ...
                        className="w-full h-full object-contain filter drop-shadow-[0_20px_35px_rgba(0,0,0,0.85)] drop-shadow-[0_0_45px_rgba(227,38,30,0.22)] select-none pointer-events-auto"
                      />
                    ) : (
                      <div className="w-full h-full p-2 bg-[#121211] border border-[#292927] rounded-sm overflow-hidden shadow-2xl relative group">
                        ...
                        <div className="absolute bottom-4 left-4 right-4 text-left">
                          <span className="text-[10px] font-mono text-[#E3261E] uppercase tracking-widest block">MACRO DETAIL WEAVE</span>
                          <span className="text-sm font-mono font-bold text-white uppercase">{currentView.tag}</span>
                        </div>
                      </div>
                    )}
                  </motion.div>
                ...
                {isScanning && (
                  <motion.div
                    ...
                    className="absolute inset-x-0 h-[2px] bg-[#E3261E] shadow-[0_0_15px_#E3261E,0_0_30px_#E3261E] pointer-events-none z-30 flex items-center justify-between px-4"
                  >
                ...
                {activeViewIndex === 0 && (
                  <div className="absolute inset-0 pointer-events-none z-20">
                    ...
                    <div
                      className="absolute top-[10%] left-[34%] pointer-events-auto cursor-pointer group"
                    ...
                    >
                      ...
                      {/* Sub-leader line indicator */}
                      <div className="w-[1px] h-4 bg-gradient-to-b from-[#9B9992]/60 to-transparent mx-auto" />
                    </div>

                    {/* Hotspot 02: Crest Callout (Right Upper Chest) */}
                    <div
                      className="absolute top-[34%] right-[2%] sm:right-[5%] pointer-events-auto cursor-pointer group"
                    ...
                    >
                      ...
                      <div className="w-6 h-[1px] bg-gradient-to-l from-[#9B9992]/60 to-transparent -translate-x-3 -translate-y-2" />
                    </div>

                    {/* Hotspot 03: Fabric Callout (Lower Torso) */}
                    <div
                      className="absolute top-[64%] right-[8%] sm:right-[10%] pointer-events-auto cursor-pointer group"
                ...
                <AnimatePresence>
                  {activeHotspot && (
                    <motion.div
                      ...
                      className="absolute bottom-1 inset-x-2 bg-[#0E0E0D]/95 backdrop-blur-md border border-[#E3261E]/70 p-3.5 rounded-sm shadow-2xl z-40 text-left"
                    >
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-mono font-bold bg-[#E3261E] text-white px-1.5 py-0.5 rounded-xs">
                            {activeHotspot.number} // {activeHotspot.label}
                          </span>
                          <span className="text-[10px] font-mono text-[#9B9992]">{activeHotspot.tech}</span>
                        </div>
                        <button
                      ...
                      <p className="text-[11px] text-[#9B9992] leading-relaxed mt-1">{activeHotspot.description}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
          ...
          <motion.div
            ...
            className="lg:col-span-3 flex flex-col justify-between space-y-4 lg:pl-4 z-20"
          >
            {/* Kit Inspector Header & Counter */}
            <div className="flex items-center justify-between border-b border-[#292927] pb-1.5 text-xs font-mono">
            ...
            {/* Vertical Angle Thumbnails Selector (Exact match to Image 2) */}
              ...
              {KIT_VIEWS.map((view, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-1.5 transition-all duration-300 text-left rounded-sm group cursor-pointer border ${
                      isActive
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {/* Thumbnail Box */}
                      <div
                        className={`w-12 h-12 shrink-0 bg-[#070707] flex items-center justify-center overflow-hidden rounded-xs border ${
                    ...
                    {isActive && (
                      <span className="w-1.5 h-1.5 rounded-full bg-[#E3261E] mr-2 animate-pulse" />
                    )}
                  </button>
                );
              })}
            ...
            <div className="p-3 bg-[#0E0E0D] border border-[#292927] space-y-1 font-mono text-[11px] text-left">
            ...
            <div className="text-left font-mono text-xs tracking-widest text-[#9B9992] flex items-center justify-between pt-0.5">
              <div>
                <span className="block text-[#F3F0E8] font-bold text-[11px]">ENGINEERED —</span>
                <span className="text-[10px] text-[#9B9992]">FOR MORE</span>
              </div>
              <button
                onClick={triggerLaserScan}
                className="flex items-center gap-1 text-[10px] text-[#E3261E] hover:text-white px-2 py-1 bg-[#151514] border border-[#292927] hover:border-[#E3261E] rounded-xs transition-colors"
      ...
      {/* ============================================================
         ...
         ============================================================ */}
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 w-full mt-4 pt-3 border-t border-[#292927]/40">
        
        {/* Interactive Match Timeline: 00' — 90' */}
        <div className="mb-4 max-w-4xl mx-auto">
          <div className="relative flex items-center justify-between text-xs font-mono text-[#9B9992] px-2 py-1">
            <span className="font-bold text-[#F3F0E8]">00'</span>
            
            {/* Timeline Progress Bar & Markers */}
            <div className="relative flex-1 mx-4 sm:mx-8 h-[2px] bg-[#292927]">
                  ...
                  >
                    ...
                    <div
                      className={`w-3 h-3 rounded-full transition-all duration-300 flex items-center justify-center ${
                        isSelected
                          ? 'bg-[#E3261E] shadow-[0_0_12px_#E3261E] scale-125'
                    ...
                    {isSelected && (
                      <div className="absolute -top-7 left-1/2 -translate-x-1/2 whitespace-nowrap">
                        <span className="text-[10px] font-mono font-bold text-[#E3261E] bg-[#0E0E0D] px-1.5 py-0.5 border border-[#E3261E]/60 rounded-xs">
          ...
          <div className="text-center">
            <span className="text-[10px] font-mono text-[#9B9992] tracking-wider uppercase">
        ...
        {/* Bottom Trust Row & Handwritten Script Signature */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center pt-1">
          
          {/* 3 Value Pillars */}
          <div className="md:col-span-9 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left border-t sm:border-t-0 sm:border-l border-[#292927]/60 sm:pl-6">
            <div className="space-y-0.5">
              <span className="block text-[10px] font-mono text-[#F3F0E8] font-bold uppercase tracking-widest">
                PREMIUM QUALITY
              </span>
              <span className="block text-[10px] font-mono text-[#9B9992] uppercase">
                AUTHENTIC KITS
              </span>
            </div>

            <div className="space-y-0.5 border-t sm:border-t-0 border-[#292927]/40 pt-2 sm:pt-0">
              <span className="block text-[10px] font-mono text-[#F3F0E8] font-bold uppercase tracking-widest">
                GLOBAL SHIPPING
              </span>
              <span className="block text-[10px] font-mono text-[#9B9992] uppercase">
